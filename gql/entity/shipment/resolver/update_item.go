...
var UpdateItem = func(params graphql.ResolveParams) (interface{}, error) {
	...
	case doc := <-docChan:
		registerResp := handleUpdateItemResponse(doc)
		return registerResp, nil
	}
}

func handleUpdateItemResponse(doc esmodel.Document) map[string]interface{} {
	if doc.Error != "" {
