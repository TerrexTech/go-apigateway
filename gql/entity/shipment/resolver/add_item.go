...
var AddItem = func(params graphql.ResolveParams) (interface{}, error) {
	...
	case doc := <-docChan:
		registerResp := handleAddItemResponse(doc)
		return registerResp, nil
	}
}

func handleAddItemResponse(doc esmodel.Document) map[string]interface{} {
	if doc.Error != "" {
